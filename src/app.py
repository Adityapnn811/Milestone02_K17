...
def handle_message(event):
    ...
    if 'carousel' in user_msg.lower():
        carousel_template = CarouselTemplate(columns=[
            CarouselColumn(thumbnail_image_url='https://img.okezone.com/content/2020/12/19/408/2330718/menikmati-pesona-golden-sunrise-dengan-7-puncak-gunung-di-temanggung-FF217tHxnd.jpg', text='Cerita hangat hari ini', title='Cerita Hangat', actions=[
